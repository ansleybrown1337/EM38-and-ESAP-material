...
-If ESAP modules say that they create a file, but no file is actually created when browsing the file explorer, you must repeat your analysis, but run ESAP as an administrator by right-clicking on it before launching.
